      ...
      {items.map(({ href, icon: Icon, label, color }) => {
        ...
        return (
          ...
          >
            ...
            <div className={`mr-auto transition-transform duration-300 ${isActive ? 'translate-x-0 text-gold-600 dark:text-gold-400' : 'translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 text-slate-500 dark:text-slate-400'}`}>
